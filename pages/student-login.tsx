...
export default function StudentLogin() {
  ...
  const metadata = generateMetadata('studentLogin');
          ...
          <div className="max-w-2xl lg:max-w-3xl mx-auto">
            <div className="bg-white rounded-3xl p-8 md:p-12 shadow-2xl border-2 border-primary/10 relative overflow-hidden">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-slate-700 mt-4">Welcome back! Sign in to continue your learning journey.</p>
              </div>
              ...
              <div className="mt-6 text-center space-y-2">
                <p className="text-slate-700">
                  ...
                  <Link href="/student-register" className="text-primary hover:underline font-semibold">
                    Sign up here
                  </Link>
                </p>
                <p className="text-slate-600 text-sm">
                  Are you a teacher?{' '}
                  <Link href="/teacher-login" className="text-primary hover:underline font-semibold">
                    Teacher Login
                  </Link>
                </p>
              </div>
