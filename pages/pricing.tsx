...
export default function Pricing() {
  ...
  const studentPlans = [
    {
      ...
      price: '999',
      features: [
        'Get up to 3 teacher contact details',
        '1 subject',
    ...
    },
    {
      ...
      price: '1,799',
      features: [
        'Get up to 10 teacher contact details',
        'Up to 3 subjects',
        'Priority teacher matching',
        'Phone & email support',
        'Detailed teacher profiles',
        'Verified teacher listings',
      ],
      featured: true,
    },
    {
      ...
      price: '2,999',
      features: [
        'Get up to 20 teacher contact details',
        'All subjects',
        'Premium teacher matching',
        '24/7 priority support',
        'Advanced teacher search',
        'Premium teacher profiles',
  ...
  const commissionPlan = {
    ...
    features: [
      ...
      'We provide confirmed student connections',
      '50% commission on first month fees',
      '100% earnings go to you after first month',
      'Unlimited student connections',
      ...
      <section className="py-16 xl:py-20 bg-gradient-hero min-h-screen">
        <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
          ...
          <div className="mb-20">
            ...
            <h4 className="text-xl md:text-2xl font-semibold text-center text-slate-700 mb-10 xl:mb-12">Subscription Plans - Get Teacher Contact Details</h4>
          ...
          <div>
            ...
            {/* Subscription Plans */}
            <div className="mb-12">
              <h4 className="text-xl md:text-2xl font-semibold text-center text-slate-700 mb-10 xl:mb-12">Subscription Plans - Get Student Contact Details</h4>
              <div className="grid md:grid-cols-3 gap-6 xl:gap-8 max-w-content mx-auto">
            ...
            <div className="mb-8">
              <h4 className="text-xl md:text-2xl font-semibold text-center text-slate-700 mb-10 xl:mb-12">Alternative Option - Commission-Based</h4>
              <div className="max-w-2xl mx-auto">
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-3xl p-8 shadow-lg border-2 border-green-200 transition-all duration-300 hover:-translate-y-4 hover:shadow-colored flex flex-col relative">
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-green-500 to-emerald-500 text-white px-6 py-1 rounded-full text-sm font-bold">
                    No Upfront Cost
                  </div>
                  <div className="text-center mb-6">
                    <h4 className="text-2xl font-bold text-slate-800 mb-4">{commissionPlan.name}</h4>
                    <div className="flex flex-col items-center gap-2">
                      <div className="flex items-baseline justify-center gap-2">
                        <span className="text-lg xl:text-xl text-slate-500">₹</span>
                        <span className="text-4xl xl:text-5xl font-extrabold text-gradient-primary">{commissionPlan.price}</span>
                        <span className="text-base xl:text-lg text-slate-500">upfront</span>
                      </div>
                      <div className="mt-2 text-sm text-slate-600">
                        <span className="font-semibold text-green-600">{commissionPlan.commission} commission</span> on first month only
                      </div>
                    </div>
                  </div>
                  <ul className="space-y-4 flex-grow mb-8">
                    {commissionPlan.features.map((feature, fIdx) => (
                      <li key={fIdx} className="flex items-start gap-3 text-slate-700">
                        <span className="fas fa-check text-green-600 mt-1" aria-hidden="true"></span>
                        <span>{feature}</span>
                      </li>
                    ))}
                  </ul>
                  <Link
                    href="/teacher-register"
                    className="w-full py-4 px-6 rounded-full font-bold text-center transition-all duration-300 hover:-translate-y-1 bg-gradient-to-r from-green-500 to-emerald-500 text-white shadow-md hover:shadow-colored"
                    aria-label="Get Started with Commission-Based Plan for Teachers"
                  >
                    Get Started
                  </Link>
                </div>
